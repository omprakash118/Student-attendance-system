const navBar = document.getElementById("student-sidebar");
        ...
        <div class="myMenu mt-8 ">
          <ul class=" flex-col rounded-2xl text-xl max-sm:text-2xl">
            ...
            <li class="p-3 pl-7 hover:bg-[#1b263b] hover:rounded-2xl   hover:text-white active:bg-[#415a77] ">
              ...
              <a href="" class="block btnHidden nav-link" data-target = "student-main"> <i class="fa-solid fa-gauge pr-4"></i>Dashboard</a>
            </li>
