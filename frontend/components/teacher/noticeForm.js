...
//                         <option value="Teachers" class="">Teacher</option>
//                         <option value="Students" class="">Student</option>
//                     </select>
...
//                 <textarea id="noticeDescription" placeholder="Description"
//                 class="mb-3 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2  placeholder-[#8e9baa] focus:outline-[#415a77]"
//                 required></textarea>
...
// const form = noticeForm.querySelector('form');
// const titleInput = document.getElementById('noticeTitle');
// const audienceInput = document.getElementById('noticeAudience');
...
//   try {
//     const res = await fetch('http://localhost:8000/api/notice/create', {
//       method: 'POST',
//       body: formData
//     });
...
//     } else {
//       alert("Failed to post notice: " + data.message);
//     }
//   } catch (error) {
