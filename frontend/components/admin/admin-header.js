...
<div class="relative mr-[4rem] max-sm:mr-[2rem] max-sm:ml-[2rem]">
    <button id="dropdownBtnO" class="flex items-center px-4 py-2 bg-[#e0e1dd] hover:text-[#e0e1dd] active:bg-[#8e9baa] hover:bg-[#415a77] rounded-lg shadow-md  text-[#415a77] transition cursor-pointer">
    ...
    <div id="dropdownMenuO" class=" w-60 bg-gray-200  shadow-md rounded-lg p-4 absolute right-0 mt-2 h-auto border border-[#415a77] hidden  transition-all duration-300 ease-in-out z-10  ">
...
const dropdownBtn = document.getElementById("dropdownBtnO");
const dropdownMenu = document.getElementById("dropdownMenuO");
